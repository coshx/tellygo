  ...
  module VoHelper
    ...
    class VoUtil
      ...
      def self.finalize_object(obj)
		...
		if (defined?(ActiveRecord) && obj.kind_of?(ActiveRecord::Base)) || obj.kind_of?(ActiveResource::Base)
      ...
      def self.get_vo_for_incoming(obj,action_class_name)
        ...
        if defined?(ActiveRecord) && ruby_obj.kind_of?(ActiveRecord::Base) 
      ...
      def self.get_vo_hash_for_outgoing(obj)
        ...
        if map = ClassMappings.get_vo_mapping_for_ruby_class(obj.class.to_s)
          ...
          if defined?(ActiveRecord) && obj.is_a?(ActiveRecord::Base)
